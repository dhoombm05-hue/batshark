...
const members: MemberInfo[] = [
  ...
  {
    name: "عبدالعزيز تركي النجيفان",
    title: "تطوير الأعمال والتقنية",
    bio: "محترف متحمس ومدفوع بالنتائج يمتلك خبرة عملية في تطوير الأعمال وتطوير الويب. يتحدث العربية والإنجليزية بطلاقة مع خبرة دولية اكتسبها من إقامة طويلة في أستراليا. يتميز بأخذ زمام المبادرة، والتعلم السريع، وتطبيق المعرفة التقنية على مشاكل الأعمال الحقيقية. المقر: الرياض، المملكة العربية السعودية.",
    experience: [
      "المبيعات وتطوير الأعمال: تصميم قنوات مبيعات متكاملة وتقييم ملفات العملاء المستهدفين",
      "التطوير التقني: بناء ونشر مشاريع الويب ومنتجات SaaS (Frontend & Backend)",
      "دمج الذكاء الاصطناعي والأتمتة لرفع الإنتاجية وتحسين العمليات",
      "إدارة العمليات وسير العمل من خلال توثيق وأنظمة رقمية تدعم النمو المستدام",
    ],
    skills: [
      "العربية: اللغة الأم",
      "الإنجليزية: احترافية",
    ...
    phone: "+966533735316",
    email: "abdulaziznejfan@gmail.com",
    accentHsl: "195 75% 50%",
    icon: Briefcase,
  },
];
