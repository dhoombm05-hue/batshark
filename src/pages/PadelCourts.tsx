...
const courtsData: Record<string, Court[]> = {
  spanish: [
    {
      id: "ace", name: "Ace Court", tag: "الفئة الاقتصادية", price: 114500, usage: "تجاري / ترفيهي",
      specs: { dimensions: "20m × 10m", glass: "زجاج مقسّى 10mm — عزل صوتي 33dB", frame: "فولاذ مجلفن S275 JR — أعمدة 80×80mm", turf: "عشب صناعي 12mm — MONDO / JUTAgrass", warranty: "10 سنوات هيكل — 7 سنوات طلاء" },
    },
    {
      id: "standard", name: "Standard Court", tag: "الأكثر طلباً", price: 124000, usage: "تجاري / احترافي",
      specs: { dimensions: "20m × 10m", glass: "زجاج مقسّى 12mm — عزل صوتي 34dB", frame: "فولاذ مجلفن S275 JR مقاوم للتآكل", turf: "عشب صناعي إسباني فاخر 12mm", warranty: "10 سنوات هيكل — 7 سنوات طلاء" },
    },
    {
      id: "panoramic", name: "Panoramic Court", tag: "الفئة الاحترافية", price: 127500, usage: "بطولات / احترافي",
      specs: { dimensions: "20m × 10m", glass: "زجاج بانورامي مقسّى 12mm — 34dB", frame: "فولاذ مجلفن S275 JR بتصميم بانورامي", turf: "عشب صناعي للبطولات 12mm", warranty: "10 سنوات هيكل — 7 سنوات طلاء" },
    },
  ],
  chinese: [
    {
      id: "cn-panoramic", name: "Panoramic Court", tag: "تصميم بانورامي", price: 64500, usage: "تجاري / احترافي",
      specs: { dimensions: "20m × 10m", glass: "زجاج مقوّى عالي الجودة", frame: "فولاذ مجلفن بالغمس الساخن Q235", turf: "عشب صناعي عالي الكثافة 8000D-13500D", warranty: "ضمان سنتين شامل" },
    },
    {
      id: "cn-super-panoramic", name: "Super Panoramic Court", tag: "أعلى فئة", price: 62500, usage: "تجاري / بطولات",
      specs: { dimensions: "20m × 10m", glass: "زجاج بانورامي متطور", frame: "فولاذ مجلفن متقدم SPHC", turf: "عشب صناعي عالي الأداء 13500D", warranty: "ضمان سنتين شامل" },
    },
  ],
};
...
const PadelCourts = () => {
  ...
  return (
    <>
      {/* Hero with real padel image */}
      <section className="relative pt-28 pb-20 px-6 overflow-hidden">
        <div className="absolute inset-0">
          <img src={padelHero} alt="ملاعب بادل" className="w-full h-full object-cover" />
        ...
        <div className="container mx-auto relative z-10 text-center">
          ...
          >
            ...
            <p className="text-padel text-sm font-bold">
              اختيارك هنا يعني استثمار ناجح ومعايير لا تُقارن
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <AnimatePresence mode="wait">
            ...
            {step === "origin" && (
              <motion.div key="origin" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.5 }}>
                ...
                <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                  {([
                    { key: "spanish" as const, flag: "🇪🇸", title: "ملاعب إسبانية", sub: "Spanish Padel Courts", desc: "أعلى معايير الجودة العالمية", count: "3 فئات" },
                    { key: "chinese" as const, flag: "🇨🇳", title: "ملاعب صينية", sub: "Chinese Padel Courts", desc: "جودة عالية وأسعار منافسة", count: "فئتان" },
                  ]).map((item) => (
                    <motion.button
                      key={item.key}
            ...
            {step === "courts" && origin && (
              <motion.div key="courts" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.5 }}>
                ...
                <div className={`grid gap-6 max-w-4xl mx-auto ${courtsData[origin].length === 3 ? "md:grid-cols-3" : "md:grid-cols-2"}`}>
